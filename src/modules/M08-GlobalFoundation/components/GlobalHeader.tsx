...
import { Phone, Mail, ShieldCheck, Menu } from 'lucide-react';
...
export const GlobalHeader: React.FC = () => {
  ...
  return (
    <header className="sticky top-0 z-40 shadow-md bg-white border-b border-slate-200">
      ...
      {/* BRAND & MOBILE MENU TOGGLE BAR */}
      <div className="py-3 px-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          {/* Logo & Title */}
          <Link to="/" className="flex items-center gap-3 group" aria-label="Corruption Free State Home">
            <img
              src="/logo.png"
          ...
          <button
            ...
            className="md:hidden p-2 text-slate-700 hover:text-blue-950 hover:bg-slate-100 rounded-lg focus:outline-none focus:ring-2 focus:ring-amber-500"
      ...
      <nav className="hidden md:block bg-blue-950 text-white border-b border-blue-900" aria-label="Main navigation">
